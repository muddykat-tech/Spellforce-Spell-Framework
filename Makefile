...
NTERNALS_OBJ = obj/sfsf.o obj/sf_modloader.o obj/sf_building_loader.o obj/sf_screens_loader.o obj/sf_asi.o obj/sf_wrappers.o obj/sf_ui_wrappers.o ${REGISTRY_OBJ} ${HANDLER_OBJ} ${HOOK_OBJ}
