...
void initialize_data_hooks()
{
    ...
    // Next I'd check is how many SF_Strings I've made that... are created without a pointer method fuuuck.
    // I need sleep now so pls fix my terrible code
    ///.... Good luck ~muddykat
    ...
    DEFINE_FUNCTION(figure, subHealth, 0x2b5b40);
