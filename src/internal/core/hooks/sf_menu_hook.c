                                                        ...
                                                        uint32_t param2)
{
    ...
    if (uVar1 == 0)
    {
        ...
        fun_009a4020(_this->CUiMain_data.CUiBuilding,
                     (*(uint32_t *)(ASI::AddrOf(0x806a86)) +
                      (_this->CUiMain_data.CGdFigure->figures[param2 >>
                                                              8].race * 4) +
                      2));
        ...
        vfun163((CMnuContainer*)_this->CUiMain_data.CUiMainDetailView, 0);
        vfun164((CMnuContainer*)_this->CUiMain_data.CUiBottom);
        vfun164((CMnuContainer*)_this->CUiMain_data.CUiMonument);
        vfun163((CMnuContainer*)_this->CUiMain_data.CUiBuilding, 0);
        return;
    }
    if (uVar1 > 9999)
    {
...
void __attribute((thiscall)) sf_handle_button_flashing_maybe(SF_CUiMain *_this)
{
    ...
    for (int i = 6; i > 0; i--)
    {
        ...
        if (uVar1 != 0)
        {
            ...
            {
                uVar1 =
                    *(uint16_t *)(*(uint32_t *)&(_this->CUiMain_data.unkn3[4]) +
                                  uVar1 * 0x188 + 0xb3);
            }
            else
            {
