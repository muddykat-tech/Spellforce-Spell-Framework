            ...
            if ((cell_x < map_size) && (cell_y < map_size))
            {
                ...
                if ((flags & 0x10) != 0)
                {
                    uint16_t target_index =
                        toolboxAPI.getFigureFromWorld(_this->SF_CGdWorldToolBox, cell_x, cell_y, 0);
                         ...
                         (_this->SF_CGdFigure->figures[target_index].owner != 0)))
                    {
                        ...
                        spellAPI.addSpell(_this->CGdSpell, spell_id, _this->OpaqueClass->current_step, &source, &target,
                                          0);
                    }
                }
            }
