...
// start of game code, above this is probably stack?
extern unsigned int GAME_BASE;
// pointer to game window is statically allocated in game exe under address GAME_BASE + WINDOW_OFFSET
extern int WINDOW_OFFSET;
// pointer to appmain, the entire game starts from this position in exe
extern unsigned int APPMAIN_OFFSET;
