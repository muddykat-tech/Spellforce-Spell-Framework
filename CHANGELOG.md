...
- Update c-cpp.yml (muddykat-tech)

## 2024-08-13

- Update Makefile (muddykat-tech)
...
- Create c-cpp.yml (muddykat-tech)
...
- All block one refresh handlers written (UnSchtalch)
...
- slient output mode, still catches errors (muddykat-tech)
...
- Updated git pre-push (muddykat-tech)
...
- Made some more Code Comments (muddykat-tech)

## 2024-06-08

- Fixed Strange Git Issues due to ammending a commit incorrectly (muddykat-tech)
...
- Merge branch 'master' of https://github.com/muddykat-tech/Spellforce-Spell-Framework Required for pushing test code. (muddykat-tech)
...
- Merge commit '28198da54cdb444b352e262874ca2a1073767cc2' (UnSchtalch)
...
- Merge commit 'ecd94efe2c4491305826de232149fbbae21f1eb4' (UnSchtalch)
