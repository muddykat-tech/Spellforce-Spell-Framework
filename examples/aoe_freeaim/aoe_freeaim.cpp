...
#define PLASMABALL_LINE 0xf8
#define SHIELD_WALL_UNIVERSAL_JOB 0xaf
...
uint16_t __thiscall plasmaball_onhit_handler(SF_CGdFigureJobs *_this, uint16_t source_index, uint16_t target_index, uint16_t damage)
...
extern "C" __declspec(dllexport) void InitModule(SpellforceSpellFramework *framework)
{
    ...
    registrationAPI->linkOnHitHandler(shield_wall_universal_spell, &plasmaball_onhit_handler);
...
{
    return framework->createModInfo("Plasmaball", "1.0.0", "Teekius", "A mod designed to demonstrate free-aim spell which damages enemies in AoE.");
}
